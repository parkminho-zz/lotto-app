...
export default function CheckLottoPage() {
  ...
  return (
    <div className="flex flex-col items-center p-10 bg-gray-100 pt-25 min-h-screen">
      ...
      <div className="bg-white rounded-xl shadow-md p-8 w-full max-w-5xl text-center overflow-y-auto">
